...
const ScheduleDashboard: React.FC = () => {
    ...
    const getbookingsforaday = (bookings: any, resourceid: string, day: number, month: number, year: number) => {
        ...
        return <TableCell sx={{ fontFamily: 'Calibri', border: '1px solid black', padding: '8px', textAlign: 'center' }}>{bookingtext.trim()}</TableCell>;
    }
    ...
    return (
        <div style={{ marginTop: '20px', marginLeft: '20px', marginRight: '20px' }}>
            <Table>
                <TableHead>
                    <TableRow>
                        <TableCell sx={{ fontFamily: 'Calibri', fontWeight: 'bold', border: 'none', padding: '8px' }}>Resource</TableCell> {/* Removed border from this cell */}
